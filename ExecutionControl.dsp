...
# PROP Target_Dir ""
# ADD CPP -MD /W3 /I "$(QTDIR)\include" /I "C:\Qt\3.3.3\project\ExecutionControl" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.3\mkspecs\win32-msvc" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /D "QT_NO_DEBUG" /FD /c -nologo -Zm200 -O1 
...
# PROP Target_Dir ""
# ADD CPP -MDd /W3 /GZ /ZI /Od /I "$(QTDIR)\include" /I "C:\Qt\3.3.3\project\ExecutionControl" /I "tmp\moc\release_mt_shared" /I "C:\Qt\3.3.3\mkspecs\win32-msvc" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QT_THREAD_SUPPORT /D QT_ACCESSIBILITY_SUPPORT /FD /c -nologo -Zm200 -Zi  
...
USERDEP_settingsdialog=""$(QTDIR)\bin\moc.exe""
...
BuildCmds= \
	$(QTDIR)\bin\moc settingsdialog.h -o tmp\moc\release_mt_shared\moc_settingsdialog.cpp \

"tmp\moc\release_mt_shared\moc_settingsdialog.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
...
SOURCE=settingsdialogbase.ui
USERDEP_settingsdialogbase.ui="$(QTDIR)\bin\moc.exe" "$(QTDIR)\bin\uic.exe"

!IF  "$(CFG)" == "ExecutionControl - Win32 Release"

# Begin Custom Build - Uic'ing settingsdialogbase.ui...
InputPath=.\settingsdialogbase.ui

BuildCmds= \
	$(QTDIR)\bin\uic settingsdialogbase.ui -o settingsdialogbase.h \
	$(QTDIR)\bin\uic settingsdialogbase.ui -i settingsdialogbase.h -o settingsdialogbase.cpp \
	$(QTDIR)\bin\moc  settingsdialogbase.h -o tmp\moc\release_mt_shared\moc_settingsdialogbase.cpp \

"settingsdialogbase.h" : "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	$(BuildCmds)

"settingsdialogbase.cpp" : "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	$(BuildCmds)

"tmp\moc\release_mt_shared\moc_settingsdialogbase.cpp" : "$(SOURCE)" "$(INTDIR)" "$(OUTDIR)"
	$(BuildCmds)
...
SOURCE=tmp\moc\release_mt_shared\moc_settingsdialog.cpp
# End Source File
# Begin Source File
...
SOURCE=tmp\moc\release_mt_shared\moc_settingsdialogbase.cpp
# End Source File
# Begin Source File
